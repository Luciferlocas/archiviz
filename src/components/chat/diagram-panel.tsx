    ...
    <AnimatePresence>
      {activeDiagram && (
        <motion.div
          ...
          className="h-full bg-stone-950 border-l border-stone-800 flex flex-col overflow-hidden shadow-2xl z-20"
        >
          <TransformWrapper
            initialScale={1}
            minScale={0.2}
          ...
          >
            {({ zoomIn, zoomOut, resetTransform, centerView }) => (
              <>
                <header className="px-5 py-3 border-b border-stone-800 flex items-center justify-between bg-stone-900/80 backdrop-blur-sm">
